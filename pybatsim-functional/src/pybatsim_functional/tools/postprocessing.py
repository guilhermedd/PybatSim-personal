"""
    pybatsim_functional.tools.postprocessing
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

    This tool may be used to postprocess experimental data for features
    introduced in the functional API.
"""
import os
...
from pybatsim_functional.events import load_events_from_file
...
def process_jobs(result_prefix,
    ...
    :param in_sched_events: the file of the events file written by the scheduler
